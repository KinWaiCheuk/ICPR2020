...
from onsets_and_frames.transcriber import OnsetsAndFrames_TCN, OnsetsAndFrames_biTCN, OnsetsAndFrames_biTCN_fully
...
def train(logdir, device, iterations, resume_iteration, checkpoint_interval, train_on, batch_size, sequence_length,
    ...
    # TCN_layers = [100, 200, 300, 384]

    TCN_layers = [2,4,8,16,32,44]
    if resume_iteration is None:
        model = OnsetsAndFrames_biTCN_fully(N_MELS, MAX_MIDI - MIN_MIDI + 1, TCN_layers, 7, model_complexity).to(device)
